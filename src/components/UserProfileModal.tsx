    ...
    <div className="fixed inset-0 z-50 bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-white overflow-y-auto w-full h-full min-h-screen animate-in fade-in duration-200">
      <div className="w-full min-h-screen flex flex-col">
        {/* Top Modal Header */}
          ...
          <div className="max-w-7xl w-full mx-auto p-4 sm:p-8 flex-1 space-y-6">
            ...
            <div className="flex items-center space-x-2">
              {onLogout && (
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-extrabold text-xs transition-all cursor-pointer shadow-md flex items-center space-x-1.5"
          ...
          {/* Navigation Tabs */}
          <div className="flex border-b border-slate-100 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-900/50 px-6 pt-3 space-x-4">
            <button
              ...
              <div className="space-y-6">
                ...
                <div className="bg-indigo-50/70 dark:bg-indigo-950/30 p-5 rounded-2xl border border-indigo-200 dark:border-indigo-800/50 space-y-2">
                  ...
                  <p className="text-xs font-extrabold text-slate-800 dark:text-zinc-100">
                    {('address' in user && user.address) || ('currentAddress' in user && user.currentAddress) || 'Flat 402, Sunshine Heights, Sector 62'}
                  </p>
